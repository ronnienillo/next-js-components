...
export default function Home() {
  ...
  return (
    <main className="text-center min-h-screen flex items-center justify-center">
      <div>
        <h1 className="text-2xl md:text-5xl mt-8 mb-2 text-[#ff6873] flex items-center gap-1 justify-center"><span className="text-5xl md:text-8xl"><SiNextdotjs/></span>ext.js Components</h1>
